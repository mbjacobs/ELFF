...
def DefineGestures():
    dict={}
    # 1. BEGIN ------------------------------------#
    VictoryPeace=Gesture("VictoryPeace")
    VictoryPeace.set_palm((475,225),45)
    VictoryPeace.set_finger_pos([(490,90),(415,105)])
    VictoryPeace.calc_angles()
    dict[VictoryPeace.getName()]=VictoryPeace
    # 1. END --------------------------------------#
    # 2. BEGIN ------------------------------------#
...
while(1):
    ...
    # Display frame in a windowPeace
